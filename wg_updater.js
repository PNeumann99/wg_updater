...
async function update_offer(interval) {
    ...
    await driver.get('https://www.wg-gesucht.de/angebot-bearbeiten.html?action=update_offer&offer_id=' + config.offer.id);
    ...
    while (true) {
        ...
        console.log('Ad last updated on: ' + new Date(Date.now()).toLocaleString('de-DE', { timeZone: 'Europe/Berlin' }));
...
dialog.entry('How often shall your ad be updated? (in minutes)\nDefault: ' + config.offer.interval / 60000, 'Enter update interval', 0, callback);